...
namespace LogicSimulator.MathParser;
...
public class MathExpressionParser
{
    ...
    /// <summary>
    /// Initialize new instance of MathExpressionParser
    ...
    public MathExpressionParser()
    {
        try
        {
            decimalSeparator = Char.Parse(System.Globalization.CultureInfo.InvariantCulture.NumberFormat.NumberDecimalSeparator);
        }
    ...
    public MathExpressionParser(char decimalSeparator)
    {
    ...
    public bool TryParse(string expression, out double result, bool isRadians = true)
    {
        this.isRadians = isRadians;

        try
        {
            result = Calculate(ConvertToRPN(FormatString(expression)));
            return true;
        }
        catch
        {
